 ...
 *	jQuery 的表单验证和显示日期时间的组件
 ...
 2. 引用日期组件laydate.js
    ...
    2.1.4 日期范围限制
        ...
        ```
        4. 只能选择当前年当前月3号到2014年12前月的当前天之间的日期<br>
        ...
        ```
        6. 前面的日期不能大于后面的日期(targetFormat参数示例)<br>
        ...
        ```
        7. 无效周(可以使用此功能禁用周日至周六所对应的日期,相关属性:disWeek (0至6 分别代表 周日至周六))<br>
